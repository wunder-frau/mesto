...
function cardPopup(cardElement) {
  let popupImage = cardElement.querySelector('.popup__image');
  ...
  // Close
  let hideImagePopup = cardElement.querySelector('.image-container__close');
  hideImagePopup.addEventListener('click', function () {
